...
class FileTransferGUI(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.server_status = tk.Label(self, text="Client1 Not Active", fg="red", font=("Arial", 12))
    ...
    def connect_to_server(self):
        self.server_status.config(text="Client1 is Active", fg="green")
